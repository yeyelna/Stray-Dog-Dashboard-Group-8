...
/* ====== 2. CARD STYLE (Border + Shadow) ====== */
/* This targets the Main Cards (KPI, Camera, Alerts, etc.) */
[data-testid="stVerticalBlockBorderWrapper"]{{
  ...
  /* FLOATING SHADOW (The requested feature) */
...
/* ====== 3. REMOVE INNER BORDER/SHADOW ====== */
/* Prevents the "box inside a box" look for scroll areas */
...
# =========================
# ROW 2: FEATURES (SHADOW + BORDER + GAP)
# =========================
