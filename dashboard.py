...
ALERTS_SCROLL_HEIGHT_PX = 520  # must be smaller than card height
...
# =========================
# ROW 2: Camera + Active Alerts (scroll in fixed height) + Picture
# =========================
